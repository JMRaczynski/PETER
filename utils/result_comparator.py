...
path_1 = "../models/Yelp/generated_rating_input_yelp.txt"
path_2 = "../models/Yelp/generated_two_recommenders_yelp.txt"
...
#          71101, 71493, 71565]  # Clothes

# filtered = [8327, 20826, 23013, 29341, 30793, 30907, 33451, 39106, 45493, 51285, 66573, 66614, 76813, 78198, 80351,
#             88331, 90822, 99145, 99773, 117531] # TA

# filtered = [6613, 43113, 55085, 62109, 65941, 70729, 80329, 93589, 96981, 102013, 120353, 128045, 131913, 133477,
#             140529, 150549, 151293, 157209, 174289, 176329] # MOVIES

# filtered = [4693, 34326, 37277, 117077, 124777, 125803, 157689, 181025, 206341, 218153, 262353, 305259, 305929, 314570,
#             343515, 369143, 380106, 402610, 415862, 422517] # YELP
